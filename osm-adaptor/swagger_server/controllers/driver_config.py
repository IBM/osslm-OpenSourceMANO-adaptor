"""
reads config file for the osm resource manager driver
...
class ConfigReader:
    ...
    class __ConfigReader:
        ...
        def __init__(self):
            ...
            self.resource_dir = cfg['osm']['resource_dir']
            ...
            self.keys_dir = cfg['osm']['keys_dir']
            ...
            self.osm_host = cfg['osm']['osm_host']
